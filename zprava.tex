...
Pokud uzel jež žádá o práci ji nedostane od žádného z uzlů, pak spustí ukončovací algoritmus(ADUV). 
...
\section{Literatura}
 \begin{verbatim} [1] https://edux.fit.cvut.cz/courses/MI-PAR/labs/prohledavani_do_hloubky 
-- Stránky cvičení - prohledávání do hloubky \end{verbatim}

 \begin{verbatim} [2] https://edux.fit.cvut.cz/courses/MI-PAR/labs/poznamky_k_implementaci 
-- Stránky cvičení - poznámky k implementaci \end{verbatim}
